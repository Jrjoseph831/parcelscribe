...
const faqs = [
  {
    q: "How do I request a UPS refund?",
    a: "UPS refunds for lost or damaged packages are handled as claims. Submit a claim with proof of shipment, proof of value, and a reimbursement request.",
  },
  {
    q: "What should I say in a UPS refund request?",
    a: "Include tracking, a short timeline, and a clear request to reimburse the item value and eligible charges.",
  },
  {
    q: "Does UPS refund shipping costs?",
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      "@type": "ListItem",
      position: 2,
      name: "UPS Refund Guide",
      item: "https://www.parcelscribe.com/ups-refund",
    },
  ],
};

export const metadata: Metadata = {
  title: "UPS Refund Guide",
  description:
    "UPS refund guide for lost or damaged packages. Learn how refunds work as claims and what to include for reimbursement.",
  alternates: { canonical: "https://www.parcelscribe.com/ups-refund" },
};

export default function UpsRefundPage() {
  return (
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-10">
        <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="space-y-2">
            ...
            <h1 className="text-3xl font-semibold text-gray-900 sm:text-4xl">UPS refund guide</h1>
            <p className="text-base text-gray-700 sm:text-lg">
              UPS refunds for loss or damage are processed as claims. Use this checklist to request reimbursement with the right evidence.
            </p>
          </div>
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <Link className={`${buttonClasses("primary")} w-full sm:w-auto`} href="/builder">Build a claim packet</Link>
            <Link className={`${buttonClasses("secondary")} w-full sm:w-auto`} href="/ups-claim">View UPS claim guide</Link>
          </div>
        </header>

        <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm sm:p-6">
            <h2 className="text-lg font-semibold text-gray-900">UPS refund steps</h2>
            <ol className="mt-3 list-decimal space-y-2 pl-5 text-sm text-gray-700 sm:text-base">
              ...
              <li>File the claim in the UPS portal with a short summary.</li>
              <li>Request reimbursement for item value and eligible charges.</li>
              <li>Reply quickly to UPS follow-up requests.</li>
            </ol>
          </div>
          <div className="rounded-2xl border border-gray-200 bg-slate-50 p-5 shadow-sm sm:p-6">
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-gray-700 sm:text-base">
              <li>Tracking history and last scan.</li>
        ...
        <section className="grid gap-6 md:grid-cols-2">
          <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm sm:p-6">
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-gray-700 sm:text-base">
              ...
              <li>List the attachments in the order UPS expects.</li>
            </ul>
          </div>
          <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm sm:p-6">
            ...
            <div className="mt-3 space-y-2">
              ...
              <Link className="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-3 text-sm font-semibold text-gray-900 shadow-sm hover:border-blue-200" href="/guides#ups-lost-package-claim">
                <span>UPS lost package guide</span>
                <span className="text-xs font-medium text-blue-600">View</span>
              </Link>
              <Link className="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-3 text-sm font-semibold text-gray-900 shadow-sm hover:border-blue-200" href="/guides#ups-damage-claim">
                <span>UPS damage claim guide</span>
                <span className="text-xs font-medium text-blue-600">View</span>
              </Link>
            </div>
          </div>
