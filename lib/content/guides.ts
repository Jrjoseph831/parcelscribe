...
export const guides: GuideEntry[] = [
  {
    ...
    description: "Photos to take, proof to attach, and how to answer UPS follow-ups for a refund.",
    keywords: ["UPS", "damage", "photos", "proof of value", "refund", "reimbursement"],
    body: "What to gather: tracking number, photos of box/label/packing/damage, proof of value.\n\nSteps: shoot exterior, label, inner packing before moving anything; add multiple angles of damage. File the claim online with a short summary, attach proof of value, and request reimbursement. Keep packaging for possible inspection and reply to UPS within 24 hours.\n\nCommon mistakes: only one blurry photo, no proof of value, throwing away the box, long paragraphs instead of bullets.",
  },
  {
    slug: "fedex-damage-claim",
    title: "FedEx Damage Claim",
    description: "Clear photo set, proof of value, and concise narrative for FedEx refunds.",
    keywords: ["FedEx", "damage", "photos", "proof of value", "refund", "reimbursement"],
    body: "What to gather: tracking number, delivery date, photos of exterior, label, packing, and damage, plus proof of value.\n\nSteps: photograph box + label, then inner packing before moving items; capture damage from multiple angles. Submit the claim with a brief summary, attach all photos and proof of value, and request reimbursement. Keep packaging until FedEx closes or waives inspection. Respond to follow-ups within a day.\n\nCommon mistakes: missing inner-packing photos, no proof of value, waiting for the recipient before filing, discarding packaging early.",
  },
  {
    slug: "ups-lost-package-claim",
    title: "UPS Lost Package Claim",
    description: "Proof of shipment + proof of value + tracking timeline for UPS refund claims.",
    keywords: ["UPS", "lost", "proof of shipment", "tracking", "refund", "reimbursement"],
    body: "What to gather: tracking history with last scan, proof of shipment (label or drop receipt), proof of value, recipient contact.\n\nSteps: summarize timeline and last scan; file the claim with attachments and contact info; request reimbursement. Follow up weekly and answer UPS info requests quickly. Appeal with clearer proof if denied.\n\nCommon mistakes: waiting weeks to file, no proof of shipment, no proof of value, leaving out contact details.",
  },
  {
    slug: "fedex-lost-package-claim",
    title: "FedEx Lost Package Claim",
    description: "How to file fast when FedEx tracking stalls or stops updating for a refund.",
    keywords: ["FedEx", "lost", "tracking", "proof of value", "refund", "reimbursement"],
    body: "What to gather: last scan, expected delivery date, proof of shipment, proof of value, recipient contact.\n\nSteps: collect shipment + value proof; submit claim with a concise refund and reimbursement request; respond to FedEx requests within 24 hours; appeal with clearer evidence if denied.\n\nCommon mistakes: waiting for more scans before filing, long narratives, missing proof of value, no contact details.",
  },
  {
