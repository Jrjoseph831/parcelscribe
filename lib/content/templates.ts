...
export const templates: TemplateEntry[] = [
  {
    ...
    description: "Short cover letter for damage or lost-package claims with evidence checklist.",
  ...
  },
  {
    slug: "appeal-letter",
    title: "Appeal Letter",
    description: "Use after a denial—restate facts and attach clearer proof.",
